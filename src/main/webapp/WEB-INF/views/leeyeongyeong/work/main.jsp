...
<body class="loading">
	<main>
		...
		<div data-scroll>
			...
			<div class="search">
			<form id='searchForm' action="/leeyeongyeong/work/main" method="get">
			...
			<c:forEach items="${work}" var="work" begin="0" step="1">
				...
				<form id='actionForm' action="/leeyeongyeong/work/main" method="get">
					<input type="hidden" name="pageNum" value="${pageMaker.cri.pageNum}">
					<input type="hidden" name="amount" value="${pageMaker.cri.amount}">
		...
		function() {
			...
			var actionForm = $("#actionForm");
				...
				$(".read").on("click", function(e){
					...
					actionForm.attr("action", "/leeyeongyeong/work/read");
					actionForm.submit();
				});	
