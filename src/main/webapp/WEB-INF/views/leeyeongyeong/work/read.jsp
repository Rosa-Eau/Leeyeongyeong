...
<body class="loading">
		...
		<div data-scroll>
			...
			<section class="section spaced">
				...
				<div class="item">
					...
					<button type="submit" class="btn btn-default" data-oper="work"> Back </button>
	...
	$(document).ready(function() {
		...
		$('button').on("click", function(e) {
			...
			if(operation === "work") {
				//move to main
				formObj.attr("action", "/leeyeongyeong/work/main");
...
$(document).ready(function() {
	  (function() {
	    ...
	    $.getJSON("${ctx}/leeyeongyeong/work/getAttachList", {wno: wno}, function(arr) {
