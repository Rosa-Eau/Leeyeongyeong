...
<head>
   <meta http-equiv="X-UA-Compatible" content="IE=edge">
    ...
    <!-- DataTables CSS -->
    <link href="/resources/css/vendor/datatables-plugins/dataTables.bootstrap.css" rel="stylesheet">

    <!-- DataTables Responsive CSS -->
    <link href="/resources/css/vendor/datatables-responsive/dataTables.responsive.css" rel="stylesheet">
